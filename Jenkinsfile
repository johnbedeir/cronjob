        ...
        stage('Update File') {
            steps {
                ...
                script {
                    ...
                    sh '''
                        cd cronjob && git pull https://${GIT_USERNAME}:${GIT_TOKEN}@github.com/johnbedeir/cronjob.git dev
                    '''
                    script {
                    ...
                    sh "git push https://${GIT_USERNAME}:${GIT_TOKEN}@github.com/johnbedeir/cronjob.git HEAD:dev"
